class CircleLeft {
  ...
  float a =0.0;
  CircleLeft(float x, float y, float restitutionValue) {
    opacity=255;
    w = 16;
    h = 16;
    //radius =setRadius;
    ...
    cs.m_radius = box2d.scalarPixelsToWorld(r/2)+0.2+addedMarginL; //.2 for 'padding' and addedMargin for extroversion!
